                ...
                if (acciones >= 12) {
                    ...
                    if (pistasConseguidas >= 2) {
                        ...
                        if (opcionFinal == 1) {
                            ...
                            // --- LÓGICA DEL RITUAL (PEGADA) ---
                            int aciertosRitual = 0;
                            int respRitual = 0;
                            ...
                            System.out.println("Necesitas al menos 2 respuestas correctas.\n");

                            // Pregunta 1
                            do {
                                System.out.println("1) ¿Qué valor importa más para recuperar la humanidad?");
                                System.out.println("1. Poder | 2. Amor | 3. Orgullo");
                                System.out.print("[+] Elige (1-3): ");
                                if(sc.hasNextInt()) respRitual = sc.nextInt();
                                else { sc.next(); respRitual = 0; }
                            } while(respRitual < 1 || respRitual > 3);
                            if(respRitual == 2) aciertosRitual++;

                            // Pregunta 2
                            do {
                                System.out.println("\n2) ¿A quién perdonarías primero?");
                                System.out.println("1. A ti mismo | 2. A los burlones | 3. A nadie");
                                System.out.print("[+] Elige (1-3): ");
                                if(sc.hasNextInt()) respRitual = sc.nextInt();
                                else { sc.next(); respRitual = 0; }
                            } while(respRitual < 1 || respRitual > 3);
                            if(respRitual == 1) aciertosRitual++;

                            // Pregunta 3
                            do {
                                System.out.println("\n3) ¿Aceptarías sacrificios por los que quieres?");
                                System.out.println("1. Sí | 2. Solo si no pierdo nada | 3. No");
                                System.out.print("[+] Elige (1-3): ");
                                if(sc.hasNextInt()) respRitual = sc.nextInt();
                                else { sc.next(); respRitual = 0; }
                            } while(respRitual < 1 || respRitual > 3);
                            ...
                            System.out.println("\nHas terminado el ritual. Aciertos: " + aciertosRitual + " de 3.");
                            // --- FIN DEL RITUAL ---
